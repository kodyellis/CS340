...
public class Pizza implements Comparable<Pizza>{
	...
	//use for loop to add toppings
	//remake code so we can easily add them without referencing index number
	
	// so make it so that implementation code add each toppping, with a for loop in implemetaiton file
	//and hopefully they add them sequentially or.........
	 ...
	 * @returns the class variable total cost
	 * */
