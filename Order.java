...
//FYI: Can make an instance var/method that holds a number for each pizze
//like pizza1, pizza2, etc
...
public class Order {
	...
	//static allows this to be sued through the whole class
	...
	public void getFile() {
		...
		try{
			input = new Scanner(new File("C:\\Users\\Kody Ellis\\eclipse-workspace\\cs340 lab2\\src\\lab2\\testFile"));
